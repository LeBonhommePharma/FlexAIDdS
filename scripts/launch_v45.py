#!/usr/bin/env python3
# launch_v45.py — daemonized launcher for the v45 cross-docking benchmark.
#
# v45 = v44 + 85-pair cyclic-shift cross-docking bijection (Astex Diverse)
#
# Cross-docking semantics:
...
#
# Differences from v44 (self-docking):
#   --benchmark crossdock_json:<pairs_file>   (85-pair JSON bijection)
#   FLEXAIDDS_RECEPTOR_ROTAMER_PREP=0         (OFF for cross-docking)
#   No FLEXAIDDS_PRIORITY_TARGETS             (cleared from env)
#
...
OUTPUT     = os.path.expanduser("~/flexaidds_results/v45_20260613_crossdock85")
...
if __name__ == "__main__":
    ...
    print(f"\nLaunching v45 cross-docking benchmark …")
    ...
    prov = {
        ...
        "description":   (
            "85-pair cross-docking bijection: receptor[i] → ligand[(i+1)%85] "
            "(cyclic shift, alphabetical order over Astex Diverse)"
        ),
        "oracle_mode":              True,
    ...
    print(f"\n✓ v45 crossdock_85 launched (commit={GIT_COMMIT})")
