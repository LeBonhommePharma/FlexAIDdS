...
| Successful poses (RMSD_hungarian < 2.0 Å) | **47 / 85 (55.3% gated hungarian<2.0 from fresh reproduce on proper 7r+THERMO reviewer trees + two-stage selector; note: some emit use stricter "success" col yielding ~43)** |
