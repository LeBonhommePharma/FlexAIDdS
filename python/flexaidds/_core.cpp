...
PYBIND11_MODULE(_core, m) {
    ...
    // ═══════════════════════════════════════════════════════════════════════
    // Thermodynamic: expose single-site Ξ and multi-N GrandCanonicalEngine.
    // GA ranking is unaffected; concentrations only retitrate Ξ / p_i / ⟨N⟩.
    {
        ...
        py::class_<GrandPartitionFunction>(m, "GrandPartitionFunction",
            ...
            .def("set_concentration", &GrandPartitionFunction::set_concentration,
                ...
                "NRGsuite retitration: set_concentration([L1,L2,...])")
            ...
            .def("mean_occupancy", &GrandPartitionFunction::mean_occupancy)
        ...
        py::class_<GrandCanonicalEngine>(m, "GrandCanonicalEngine",
            ...
            .def("log_intrinsic_selectivity",
                &GrandCanonicalEngine::log_intrinsic_selectivity)
