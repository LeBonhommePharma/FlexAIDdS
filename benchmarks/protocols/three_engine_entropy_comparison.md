...
| Known local copies (verify, do not assume) | Repo / `WRK/MC_st0r5.2_6.dat` hashes to **`9dc93717…` (9dc9)** — the claim/comparative pin. **`72d7c739…` is a packing-sweetened historical fork**; do not use it for these arms. Copy the 9dc9 file into every arm’s `DEPSPA` / data dir |
...
Default matrix pin: `9dc93717dfed0698006d88dd6a9627bc` (**9dc9**; or `RUN_RECEIPT.json` / `provenance.json` that records that same MD5). Do not default to the historical 72d7 packing fork.  
...
| Matrix MD5 choice among local copies | Claim/comparative pin is **9dc9** (`9dc93717…`). **72d7** is a packing-sweetened historical fork — do not use it; **copy the 9dc9 file** to all arms |
