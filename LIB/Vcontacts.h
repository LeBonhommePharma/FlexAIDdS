...
struct VC_Global_struct{
	...
	int        calc_count;            // initialized entries in Calc/Calclist
...
atomindex* index_protein(FA_Global*,atom*,resid*,atomsas*,int*,int*,int,atomindex*,std::map<std::string, atomindex*> &,int*);
...
int     get_contlist4(atom*,int, contactlist *, int, float, int, atomsas*, const int*, const atomindex*, const ca_struct*, const int*, double*, double, float, float, float, resid*,int*);
