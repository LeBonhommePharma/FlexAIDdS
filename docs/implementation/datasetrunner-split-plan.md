...
## Integration note (merge/science-residual-stack)
Run path uses `RunReceipt` (PR #277) for RUN_RECEIPT.json + provenance.json. `DatasetRunnerProvenance` leaf (PR #272) remains for unit tests / shared helpers; hardened to argv hashing.
