...
**Status:** recorded OPS session (pre-merge vs later PRs; not a 3Dsig S_top10 claim table). **Not a published FlexAIDdS success rate** — unverified / no METHODOLOGY.md §0 receipt. Do not cite 25.3% as current docking power.  
...
| This 25.3% figure | OPS session record — **not** a published docking-power rate |
